...
export default function ApartmentPhotos() {
  ...
  const uploadFiles = async (files) => {
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      formData.append("apartmentId", aptId);
      await fetch("/api/panel/photos", { method: "POST", body: formData });
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f0f2f5", fontFamily: "Poppins, sans-serif" }}>
      ...
      <div style={{ padding: "32px", maxWidth: "1280px", margin: "0 auto" }}>
          ...
          >
            {uploading ? (
              <div>
                ...
                <p style={{ color: "#007CBA", fontWeight: "500", marginBottom: "12px" }}>
                  Przesyłanie… {uploadProgress}%
                </p>
                <div style={{ width: "200px", height: "6px", backgroundColor: "#e0e0e0", borderRadius: "3px", margin: "0 auto" }}>
              ...
              <div>
                ...
                <p style={{ fontWeight: "500", color: "#333", marginBottom: "6px" }}>
                  Kliknij lub przeciągnij zdjęcia tutaj
                </p>
                <p style={{ fontSize: "12px", color: "#999" }}>
                  JPG, PNG, WEBP — można wybrać wiele plików naraz
                </p>
              </div>
            )}
            <input
        ...
        <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "24px", boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
          <h3 style={{ fontSize: "15px", fontWeight: "600", color: "#111", marginBottom: "20px" }}>
            Zdjęcia
            <span style={{ fontWeight: "400", color: "#888", marginLeft: "8px" }}>({photos.length})</span>
          </h3>
          ...
          {loading ? (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "16px" }}>
              {photos.map((photo) => (
                <div
                  key={photo.public_id}
                  style={{ position: "relative", borderRadius: "10px", overflow: "hidden", backgroundColor: "#f0f0f0", aspectRatio: "4/3", boxShadow: "0 2px 6px rgba(0,0,0,0.08)" }}
                >
                  <img
